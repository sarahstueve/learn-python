...
Then, you'll be asked to select the destination folder where it should be installed, select the start menu folder, and delect additional tasks. For each of these installer pages, you should accept the defaults Positron suggests by clicking `Next`.
