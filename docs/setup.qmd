...
The Positron installer will appear in your `Downloads` folder. In `Finder` ![](figures/setup/finder-icon.jpeg){width=24} for Mac or `File Explorer` ![](figures/setup/file-explorer-windows-25539_64.png){width=24} for Windows, navigate to your `Downloads` folder in the left sidebar. When you click on the installer, it will open a window where you will drag and drop Positron into your `Applications` folder:
